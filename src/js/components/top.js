...
export default class Top extends Component {
    ...
    render() {
        return (
            <div onClick={this.backToTop.bind(this)} ref="back_to_top" id="back-to-top" className="red btip" data-scroll="body" style={{display: 'block'}}>
                <svg id="point-up" width="34" height="34" viewBox="0 0 34 34">
                    <path
